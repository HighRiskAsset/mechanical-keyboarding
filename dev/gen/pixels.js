...
(function () {
  ...
  const GLYPHS = {
    ...
    // ---- letters (2026-09-15): the bag panel names its rows. Capitals only,
    // 5px tall like the digits, Latin then Cyrillic (Ё is drawn as Е: five
    // pixels have no room for its dots). Appended after the marks so every
    // cell already on the font sheet keeps its place when it is re-baked.
    ...
    'Д': ['0110', '0101', '0101', '1111', '1001'],
    'Е': ['111', '100', '110', '100', '111'],
    'Ё': ['111', '100', '110', '100', '111'],
    'Ж': ['10101', '10101', '01110', '10101', '10101'],
    'З': ['110', '001', '010', '001', '110'],
