...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      benchAutoNote: 'This mine now works without you: hold Space at it to draw a load of 100. Buying it a new Mk hands it back to you until you automate it again. Belts come next.',
      ...
      autoNoteProcessor: 'This machine now runs itself on the clock, from what its belts bring it — or what you feed it by hand (hold Space → feed). Collect its output at the machine, or belt it onward. It no longer takes your typing; its newer recipes are still yours at other machines.',
    ...
    ru: {
      ...
      benchAutoNote: 'Этот рудник теперь работает без вас: зажмите пробел у него, чтобы забрать 100. Новый Mk вернёт его в ваши руки, пока вы не автоматизируете его снова. Ленты — следом.',
      ...
      autoNoteProcessor: 'Эта машина теперь работает сама, по часам, из того, что приносят ленты — или того, что вы положите в неё вручную (зажмите пробел → загрузить). Заберите продукцию у машины или пустите дальше по ленте. Вашу печать она больше не принимает.',
