...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      mapRich: (p) => `rich veins ×${p.n}`,
      mapNew: 'Untouched',
      mapProgress: (p) => `${p.letters} letters · ${p.kits} kits · ${p.chars.toLocaleString('en-GB')} keystrokes`,
    ...
    ru: {
      ...
      mapRich: (p) => `богатые жилы ×${p.n}`,
      mapNew: 'Нетронутый',
      mapProgress: (p) => `букв: ${p.letters} · наборов: ${p.kits} · нажатий: ${p.chars.toLocaleString('ru-RU')}`,
