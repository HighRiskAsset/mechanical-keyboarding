...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      importConfirmNote: 'Progress on this device will be replaced by the save from the file. This cannot be undone.',
      importMeta: (p) => `Exported ${p.date}`,
    ...
    ru: {
      ...
      importConfirmNote: 'Прогресс на этом устройстве будет заменён сохранением из файла. Это действие необратимо.',
      importMeta: (p) => `Экспортировано ${p.date}`,
