// Standard Russian ЙЦУКЕН layout as a pluggable data file.
// The game maps physical keys (KeyboardEvent.code) to glyphs itself, so no
// OS layout switch is needed. Global namespace: LAYOUT_RU
(function () {
  'use strict';
  ...
  window.LAYOUT_RU = {
    id: 'ru-jcuken',
    name: 'Русская (ЙЦУКЕН)',
    CODE_TO_CHAR, SHIFTED_CODE_TO_CHAR, NEEDS_SHIFT, CHAR_TO_CODE, CODE_TO_QWERTY,
    KEY_GEOMETRY, FINGER, HOME_CODES,
  };
})();
